<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="trip.WebForm2" %>
    ...
    <header>
      ...
      <div class="navbar navbar-fixed-top">
        <div class="navbar-inner">
          <div class="container">
            <a href="Webform1.aspx" class="brand brand-bootbus">Trip Mania</a>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="span6 offset3">
            <h4 class="widget-header"><i class="icon-gift"></i>Search...Travel...Explore...Share</h4>
